...
export default function UpdateUserForm({ refreshServiceList, closeDialog, businessId, setResponseMessage }) {
    // State management
    ...
    return (
        <>
            <Box as="form" sx={styles.form} onSubmit={handleSubmit(submitNewService)}>
                <Controller
                    name="name"
                    control={control}
                    render={({ field }) => (
